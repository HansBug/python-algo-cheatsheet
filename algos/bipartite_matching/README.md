...
- [洛谷专栏：二分图浅析（中文版）](https://www.luogu.com/article/ij4okb50) - 从二分图基础到匹配思路都讲得比较顺，适合先建立整体概念
- [CSDN：二分图匹配 匈牙利算法](https://blog.csdn.net/Young__Fan/article/details/90719285) - 更偏模板和例题，适合把增广路径和代码实现对起来
...
|------|-------------|----------|------|---------|
| 匈牙利算法 | [hungarian.py](hungarian.py) 里的 `Hungarian` 类 | `36.9` | 现场高风险 | 提前背熟再进场，别指望现场临时推出来 |

这类模板的代码行数不算夸张，但 DFS 增广和匹配状态来回改写，现场手写风险并不低。
